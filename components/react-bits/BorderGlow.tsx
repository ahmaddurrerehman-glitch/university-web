...
// Source: https://reactbits.dev — BorderGlow component
...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 348, s: 83, l: 47 }
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    <div
      ...
      className={`relative grid isolate border border-white/8 ${className}`}
      style={{
