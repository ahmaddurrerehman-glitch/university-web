    ...
    <section className="section-padding bg-surface/50">
      <div className="max-w-7xl mx-auto">
            ...
            return (
              ...
              >
                <Link href={`/departments#${dept.slug}`} className="group block">
                  <div className="glass-card rounded-2xl p-6 border border-white/[0.06] group-hover:border-white/15 transition-all duration-300 group-hover:translate-y-[-4px] h-full">
                    <div
        ...
        <div className="mt-10 text-center">
          <Link
            href="/departments"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl glass border border-white/10 text-slate-300 hover:text-white hover:border-white/20 text-sm font-medium transition-all"
          >
